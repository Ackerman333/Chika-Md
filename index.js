...
case 'menu': {
if(typemenu == 'image'){
await chika.send5ButImg(from, `` + '' + lang.menu(botname, pushname, salam), `© ${ownername}`,thumb, [{"urlButton": {"displayText": "Group","url": `https://chat.whatsapp.com/Fd92L258maQ6lWjIua6Djq`}},{"urlButton": {"displayText": `Instagram`,"url": `https://instagram.com/irja_official`}},{"quickReplyButton": {"displayText": "Owner","id": 'owner'}},{"quickReplyButton": {"displayText": "List Menu","id": 'command'}}] )
}
if(typemenu == 'gif'){
